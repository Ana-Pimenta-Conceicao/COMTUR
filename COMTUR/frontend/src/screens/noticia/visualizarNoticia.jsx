  ...
  return (
    <div>
      ...
      <div className="flex flex-col pl-24 pr-24">
        <h1 className="text-[#373636] text-4xl font-extrabold pt-14">
          {noticia.titulo}
        </h1>
        <h2 className="text-[#373636] text-xl font-semibold pt-3">
          {noticia.subtitulo}
        </h2>
        <p className="text-[#373636] text-l font-normal pt-1">
      ...
      <div className="flex justify-center items-center">
        ...
        <div className="pt-5 pb-5 pl-8 pr-8 sm:pl-64 sm:pr-64 sm:min-w-[320px] lg:w-[90%] xl:w-[80%] 2xl:w-[70%]">
            ...
            <div key={noticia.id} className="p-4">
              <div className="grid grid-cols-2 border-2 border-[#DBDBDB]">
                {noticia.arquivoImagem && (
                  <img
                    src={noticia.arquivoImagem}
                    alt="Preview"
                    className="flex w-full h-64 border-r-2"
                  />
                )}
                <div className="pl-6 pt-3">
                  <h2 className="pr-6 text-[#373636] font-semibold text-base uppercase">
                    {noticia.titulo}
                  </h2>
                  <h2 className="pr-6 pt-1 text-[#373636] font-normal text-sm">
                    {noticia.subtitulo}
                  </h2>
                  <div className="flex">
                    <button className="mt-6 bg-[#FFD121] text-[#373636] font-medium hover:bg-black hover:text-white w-32 h-10">
                      Leia Mais
                    </button>
                  </div>
                </div>
              ...
              <div className="relative">
                <div className="absolute bottom-0 right-0">
                  <div className="flex justify-center items-center text-[#373636] font-medium bg-[#FFD121] w-32 h-8">
