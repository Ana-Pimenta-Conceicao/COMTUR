      ...
      <div className="container display" style={{ marginTop: "4%" }}>
        <div className="row">
          {(!isSmallScreen || (isSmallScreen && showFirstCard)) && (
            <div
              className={isSmallScreen ? "card-flex col-12" : "card-flex col-7"}
            >
          ...
          {(!isSmallScreen || (isSmallScreen && !showFirstCard)) && (
            ...
            >
              ...
              <div style={{ marginTop: "15px" }}>
                ...
                <input
                  className={isSmallScreen ? "col-12" : "col-11 display c_text"}
                  type="email"
                  name="email"
                  id="email"
                ...
                <input
                  className={
                    isSmallScreen ? "col-12" : "col-11 display c_text "
                  }
                  type="password"
                  name="password"
                  id="password"
                ...
                <div className="marg">
                  <button
                    className={
                      isSmallScreen
                        ? "col-12"
                        : "col-11 display c_text btn-cadastrar"
                    }
                  >
                    Cadastrar
                  </button>
