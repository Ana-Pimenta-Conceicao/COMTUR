    ...
    <div className="bg-black w-full min-h-screen">
      <div className="flex flex-col md:flex-row h-full">
        ...
        <div className="flex flex-col w-full pt-5 justify-center items-center">
          ...
          />
<div className={`flex flex-col w-1/2 ${showSignupForm ? 'hidden sm:flex' : 'sm:flex'}`}> 
...
<div className={`flex flex-col w-1/2 ${showSignupForm ? 'sm:flex' : 'hidden sm:flex'}`}> 
{/* Adicionada condição para exibir ou ocultar o formulário de login */}
