          ...
          <tbody>
            {data.map(noticia => (
              <tr className="bg-white border-b dark:bg-slate-100" key={noticia.id}>
                ...
                <td>
                  <button className="text-white bg-teal-800 hover:bg-teal-900 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
