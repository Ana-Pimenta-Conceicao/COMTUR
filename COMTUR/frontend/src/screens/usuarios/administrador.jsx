...
export default function Administrador() {
  ...
  ? currentItems
      .filter((usuario) => usuario.tipoUsuario === 4) // Filtrar apenas os usuários com tipo de usuário igual a 2
      .map((usuario) => {
        ...
        >
          ...
          <div className="pl-8 pr-8 pt-[20px]">
            <div className="flex justify-between items-center">
              <h1 className="text-3xl font-semibold">Lista de Administradores</h1>
            </div>
